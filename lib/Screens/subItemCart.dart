...
class SubItemCart extends StatefulWidget {
  ...
  @override
  _SubItemCartState createState() => _SubItemCartState();
}
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "${DemoLocalizations.of(context).title['TotalPrice']} : ${widget.c.price2 * quantity ?? 0 + widget.c.offerPrice}" +

...
class _state extends State<Orders> {
  ...
  List<OrderDetailsScreen> orderDetails;
...
//     setState(() {});
//     SharedPreferences prefs = await SharedPreferences.getInstance();
//     orders = await orderServices.GetOrdersUpdate(prefs.getString("UserId"), status_id);
...
//                                     Navigator.push(
//                                         context,
//                                         GlobalFunction.route(OrderDetails(
//                                             orderList: orders[index])));
//                                   },
//                                   child: Container(
//                                     margin: EdgeInsets.only(
//                                       top: MediaQuery.of(context).size.height *

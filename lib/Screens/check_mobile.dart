              ...
              children: [
                ...
                GestureDetector(
                  onTap: () async {
                    ...
                    var result = await _services.checkMobile(phoneController.text);
                    // var result = await _services.checkMobile(key + phoneController.text);
                    ...
                    if (result == true) {
                      ...
                      SnackBarService.showErrorMessage(
                        DemoLocalizations.of(context).title['yourPhoneExisting'],
                      );

...
class splashState extends State<Splash> {
  ...
  loadData() async {
    ...
    print(
        "sss_________________________________________________________________________________________________");
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: new BoxDecoration(color: Color(h.mainColor)),
      child: Column(
        children: [

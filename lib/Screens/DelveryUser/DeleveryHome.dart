...
class _State extends State<DeleveryHome> {
  ...
  Widget build(BuildContext context) {
    titles = [
      ...
      DemoLocalizations.of(context).title['orders'],
      DemoLocalizations.of(context).title['notifications'],
      DemoLocalizations.of(context).title['account'],
    ];
    return SafeArea(
      child: Scaffold(
                    ...
                    GestureDetector(
                        onTap: () {
                          Navigator.push(context,
                              GlobalFunction.routeBottom(Notifications()));
                        },
                        child: Container(
                            padding: EdgeInsets.all(2),
                            child: ImageIcon(
        ...
        bottomNavigationBar: BottomNavigationBar(
            ...
            items: [
              ...
              BottomNavigationBarItem(
                  ...
                  label: DemoLocalizations.of(context).title['orders'],
                  /*Text(
                    DemoLocalizations.of(context).title['orders'],
                    style: TextStyle(
                      height: 1.75,
              ...
              BottomNavigationBarItem(
                  icon: ImageIcon(
                    AssetImage("images/icon/NotificationIcon.png"),
                    size: 18,
                  ),
                  label: DemoLocalizations.of(context).title['notifications'],
                  /*Text(
                    DemoLocalizations.of(context).title['notifications'],
                    style: TextStyle(
                      height: 1.75,
              ...
              BottomNavigationBarItem(
                  icon: ImageIcon(
                    AssetImage("images/icon/user.png"),
                    size: 18,
                  ),
                  label: DemoLocalizations.of(context).title['notifications'],
                  /*Text(

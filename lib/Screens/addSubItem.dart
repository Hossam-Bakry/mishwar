                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        if (widget.quantity > 0) {
                          widget.quantity -= 1;
                          widget.subItemTotalPrice = widget.quantity * double.parse(widget.subItemProduct.price2);
                          print('total subitem price${widget.subItemTotalPrice}');
                        ...
                        Provider.of<SlmlmProvider>(context, listen: false).subItemQuantity = widget.quantity;
                      },
                    ),
                  ),
                  Container(

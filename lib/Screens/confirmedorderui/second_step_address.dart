                                  ...
                                  if (addressList[index].isPrimary == "1") {
                                    Future.delayed(Duration(seconds: 0),
                                      ...
                                      Provider.of<GetDeliveryValueProvider>(context, listen: false)
                                          .getDeliveryValue(double.parse(addressList[index].deliveryFee),
                                      );
                                    });
                                    Provider.of<GetDeliveryValueProvider>(context, listen: false).priceDelivery = double.parse(addressList[index].deliveryFee);
                                    print(
